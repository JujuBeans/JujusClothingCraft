...
import clothingcraft.items.ClothingCraftPatternItemList;
import clothingcraft.items.ClothingCraftToolsItemList;
import clothingcraft.items.ClothingCraftWardrobeItemList;
import clothingcraft.items.ItemCotton;
import clothingcraft.items.ItemCottonArmor;
import clothingcraft.items.ItemCottonSeeds;
