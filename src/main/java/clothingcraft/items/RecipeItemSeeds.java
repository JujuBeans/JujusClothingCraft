...
public class RecipeItemSeeds extends ItemSeeds implements IPlantable
{
    private final Block theBlockPlant;
    
    /**
     * Block ID of the soil this seed should be planted on.
     */
    private final Block soilId;

    public RecipeItemSeeds( 
          Block parBlockPlant, Block parSoilBlock)
    {
        super(parBlockPlant, parSoilBlock);
